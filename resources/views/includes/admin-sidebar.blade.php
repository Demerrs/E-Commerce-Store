...
<div class="off-canvas position-left reveal-for-large nav" id="offCanvas" data-off-canvas>
    ...
    <ul class="vertical menu">
        ...
        <li><a href="/admin/transactions/orders"><i class="fa fa-shopping-cart" aria-hidden="true"></i>&nbsp; View Orders</a></li>
        <li><a href="/admin/transactions/payments"><i class="fa fa-money fa-fw" aria-hidden="true"></i>&nbsp; Payments</a></li>
        <li><a href="/logout"><i class="fa fa-sign-out fa-fw" aria-hidden="true"></i>&nbsp; Logout</a>
    </ul>
